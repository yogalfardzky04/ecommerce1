...
<html>
  <head>
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="{{ asset('obaju') }}/vendor/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="{{ asset('obaju') }}/vendor/font-awesome/css/font-awesome.min.css">
    <!-- Google fonts - Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,700">
    <!-- owl carousel-->
    <link rel="stylesheet" href="{{ asset('obaju') }}/vendor/owl.carousel/assets/owl.carousel.css">
    <link rel="stylesheet" href="{{ asset('obaju') }}/vendor/owl.carousel/assets/owl.theme.default.css">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('obaju') }}/css/style.default.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{ asset('obaju') }}/css/custom.css">
    <!-- Favicon-->
  ...
  <body>
    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              <ul class="menu list-inline mb-0">
                @if(auth()->check())
                  <li class="list-inline-item"><a href="/profil">Hai, {{ auth()->user()->name }}</a></li>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.html" class="navbar-brand home"><img src="{{ asset('obaju') }}/img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="{{ asset('obaju') }}/img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
          ...
          <div id="navigation" class="collapse navbar-collapse">
                ...
                <ul class="dropdown-menu megamenu">
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="banner"><a href="#"><img src="{{ asset('obaju') }}/img/banner.jpg" alt="" class="img img-fluid"></a></div>
                        <div class="banner"><a href="#"><img src="{{ asset('obaju') }}/img/banner2.jpg" alt="" class="img img-fluid"></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="{{ route('obaju.cart') }}" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span>
              @if(auth()->check())
               {{ auth()->user()->carts()->count() }} items
               @else
                  0 item
              @endif
              </span></a></div>
      ...
      <div id="search" class="collapse">
        <div class="container">
          <form role="search" class="ml-auto" action="{{ route('obaju.cari') }}" method="GET">
            {{ @csrf_field() }}
    ...
    *** COPYRIGHT ***
    ...
    <!-- *** COPYRIGHT END ***-->
    <!-- JavaScript files-->
    <script src="{{ asset('obaju') }}/vendor/jquery/jquery.min.js"></script>
    <script src="{{ asset('obaju') }}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('obaju') }}/vendor/jquery.cookie/jquery.cookie.js"> </script>
    <script src="{{ asset('obaju') }}/vendor/owl.carousel/owl.carousel.min.js"></script>
    <script src="{{ asset('obaju') }}/vendor/owl.carousel2.thumbs/owl.carousel2.thumbs.js"></script>
    <script src="{{ asset('obaju') }}/js/front.js"></script>
    <script>
      $(document).ready(function(){
        $(".qty-carts").change(function(){
          let id=$(this).data('id')
          let value=$(this).val()
          $.ajax({
            url:"{{ route('obaju.updateQuantity') }}",
            data:{
              _token:"{{ csrf_token() }}",
              id:id,
              quantity:value
            ...
            success:function(response){
              ...
              alert('Berhasil menambahkan quantity!')
            }
          })
        })
      })
